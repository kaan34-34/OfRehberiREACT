...
import { getSubCategoriesByCategory } from '../api/businessService';

export default function SubCategorySlider({ categoryId, subCategories = [], selectedSub, onSubSelect }) {
  const subs = getSubCategoriesByCategory(subCategories, categoryId);
